...
cc.Class({
    ...
    onCollisionEnter: function (other) {
        if (
            (this.joystickInfo.publicAngle >= -180 && this.joystickInfo.publicAngle <= 0)
        ) {
    ...
    if (this.joystickInfo.publicAngle <= 180 && this.joystickInfo.publicAngle >= 0) this.joystickInfo.flagy = 1;
